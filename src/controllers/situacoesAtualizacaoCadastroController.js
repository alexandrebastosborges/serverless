...
async function situacoesAtualizacaoCadastro(
  request,
  eventosService,
  getValueParam,
  requestMapper
  ...
  try {
    ...
    const APIResponse = await eventosService.situacoesAtualizacaoCadastroServices(urlBackEnd, request);
...
module.exports = situacoesAtualizacaoCadastro;
