 function situacoesAtualizacaoCadastroServices(url, request, axios) {
  ...
  urlComplete =`${url}/empresas/${pathParameters.codigoEmpresa}/filiais/${pathParameters.codigoFilial}/clientes/${pathParameters.numeroCliente}/situacoes-atualizacao-cadastro`;
